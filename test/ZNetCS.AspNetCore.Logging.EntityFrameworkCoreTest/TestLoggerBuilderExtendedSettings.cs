// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TestLoggerBuilderExtendedSettings.cs" company="Marcin Smółka">
...
/// </summary>
[TestClass]
public class TestLoggerBuilderExtendedSettings
{
    ...
    {
        using var factory = new TestWebApplicationFactory(TestVersion.BuilderExtendedSettings);
