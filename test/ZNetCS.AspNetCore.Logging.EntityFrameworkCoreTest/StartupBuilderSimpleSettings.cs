// --------------------------------------------------------------------------------------------------------------------
// <copyright file="StartupBuilderSimpleSettings.cs" company="Marcin Smółka zNET Computer Solutions">
...
namespace ZNetCS.AspNetCore.Logging.EntityFrameworkCoreTest
{
    ...
    /// The startup.
    /// </summary>
    public class StartupBuilderSimpleSettings
    {
        ...
        public void Configure(IApplicationBuilder app, ILoggerFactory loggerFactory)
        {
            ...
            app.Use(
                async (context, next) =>
                {
                    logger.LogDebug(10, "Debug information should be ignored.");
