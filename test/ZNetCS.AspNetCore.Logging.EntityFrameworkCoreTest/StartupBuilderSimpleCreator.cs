// --------------------------------------------------------------------------------------------------------------------
// <copyright file="StartupBuilderSimpleCreator.cs" company="Marcin Smółka">
...
/// The startup.
/// </summary>
public class StartupBuilderSimpleCreator
{
    ...
    public void Configure(IApplicationBuilder app, ILoggerFactory loggerFactory)
    {
        ...
        app.Use(
            async (_, next) =>
            {
                ...
                await next.Invoke();
                logger.LogInformation(2, "Finished handling request {Param}", "param 1");
            });
